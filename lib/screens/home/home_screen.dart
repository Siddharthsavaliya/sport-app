...
class _HomeScreenState extends State<HomeScreen> {
  @override
  void initState() {
    BlocProvider.of<SignUpBloc>(context).add(CheckIsSuspended());
    super.initState();
  }
                    ...
                    child: StaggeredGrid.count(
                      ...
                      children: [
                        ...
                        StaggeredGridTile.count(
                          ...
                          child: buildImageCard(1, AppAssets.train, "Training",
                              () {
                            Navigator.push(
                                context,
                                CupertinoPageRoute(
                        ...
                        StaggeredGridTile.count(
                          crossAxisCellCount: 1,
                          mainAxisCellCount: 0.37,
                          child: buildImageCard(3, AppAssets.camera, "Gallery",
                              () {
                            // Navigator.push(
                            //     context,
                            //     CupertinoPageRoute(
