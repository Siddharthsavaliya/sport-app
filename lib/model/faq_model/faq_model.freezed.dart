...
abstract class $FaqModelCopyWith<$Res> {
  ...
  @useResult
  $Res call(
      {String? question, String? answer, @JsonKey(name: '_id') String? id});
}
...
class _$FaqModelImpl implements _FaqModel {
  _$FaqModelImpl({this.question, this.answer, @JsonKey(name: '_id') this.id});
  ...
  @override
  String toString() {
    return 'FaqModel(question: $question, answer: $answer, id: $id)';
  }
  ...
  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, question, answer, id);
...
abstract class _FaqModel implements FaqModel {
  factory _FaqModel(
      {final String? question,
      final String? answer,
      @JsonKey(name: '_id') final String? id}) = _$FaqModelImpl;
